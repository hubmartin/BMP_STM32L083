...
#define BOARD_IDENT "Black Magic Probe (BigClown), (Firmware " FIRMWARE_VERSION ")"
#define DFU_IDENT   "Black Magic Firmware Upgrade (BigClown)"
...
#define GPIO_SPEED	GPIO_OSPEED_25MHZ
